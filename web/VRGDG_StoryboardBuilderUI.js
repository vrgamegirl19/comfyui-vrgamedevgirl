...
export const STORYBOARD_CAMERA_FLOW_PRESETS = {
  ...
  music_video: {
    ...
    sequence: [
      { shot: "wide performance shot with her centered in the environment", camera: "slow performance drift" },
      { shot: "full-body shot walking toward the camera", camera: "track backward" },
      { shot: "side-tracking shot following her movement", camera: "side track" },
      { shot: "low-angle full-body performance shot", camera: "low-angle tracking move" },
      { shot: "high-angle shot looking down at her", camera: "high-angle crane drift" },
      ...
      { shot: "circular camera move around her", camera: "full circular orbit" },
      { shot: "profile shot while she walks", camera: "profile side track" },
      { shot: "rear tracking shot following her from behind", camera: "rear follow" },
      { shot: "overhead shot of her lying or moving on the ground", camera: "overhead tracking drift" },
      { shot: "Dutch-angle performance shot", camera: "tilted handheld drift" },
      { shot: "static shot with her moving through the frame", camera: "locked-off composition" },
      { shot: "camera crossing from behind her to the front", camera: "wraparound reveal" },
      ...
      { shot: "camera following her through a doorway", camera: "doorway follow-through" },
      { shot: "wide shot with her isolated in the environment", camera: "slow environmental drift" },
      ...
      { shot: "ground-level shot looking upward as she approaches", camera: "ground-level push-in" },
      { shot: "elevated crane-style reveal", camera: "crane rise" },
      { shot: "continuous one-take shot following her", camera: "continuous tracking move" },
  ...
  fisheye_distorted: {
    ...
    sequence: [
      { shot: "extreme fisheye shot with her leaning toward the lens", camera: "dramatic fisheye push-in" },
      { shot: "full-body fisheye shot with exaggerated perspective", camera: "wide fisheye drift" },
      { shot: "low-angle fisheye shot as she looks down into the camera", camera: "low fisheye tilt-up" },
      ...
      { shot: "camera placed on the floor as she walks around it", camera: "ground-level fisheye rotation" },
      { shot: "camera tilted upward as she bends toward the lens", camera: "upward fisheye tilt" },
      { shot: "distorted wide shot with the environment curving around her", camera: "curved-perspective drift" },
      { shot: "face close to the lens while her body recedes behind it", camera: "fisheye pullback" },
      { shot: "camera rotating slightly as she stares into the lens", camera: "rolling fisheye rotation" },
      { shot: "moving past the lens with warped motion", camera: "warped pass-by move" },
      { shot: "camera positioned between her feet as she looks down", camera: "upward fisheye tilt" },
      { shot: "fisheye shot from inside a doorway as she approaches", camera: "doorway fisheye push-in" },
      ...
      { shot: "low fisheye shot with her hair falling toward the camera", camera: "low fisheye tilt" },
      ...
      { shot: "camera placed on the ground while she walks around it", camera: "ground-level orbit" },
      { shot: "camera pushed toward her face, then pulled back to full body", camera: "fisheye push-pull" },
      { shot: "fisheye lens pointed upward as she spins above it", camera: "upward spinning fisheye" },
      { shot: "singing directly into the lens with exaggerated perspective", camera: "fisheye vocal push-in" },
      { shot: "handheld camera held at arm's length as she looks into it", camera: "handheld fisheye sway" },
      { shot: "centered fisheye shot with the entire background bending around her", camera: "centered warped drift" },
    ],
  },
  quiet: {
