...
class GeminiNode(ComfyNodeABC):
            ...
            "required": {
                ...
                "seed": (
                    IO.INT,
                    {
                        ...
                        "max": 0xFFFFFFFFFFFFFFFF,
                        "control_after_generate": True,
                        "tooltip": "Fixed seed value for reproducibility. Default is random.",
                    },
                ),
            },
            "optional": {
                ...
                "string_input": (
                    ...
                    {
                        "default": None,
                        "tooltip": "Optional extra text content passed as a string from another node.",
                    },
                ),
            },
            "hidden": {
    ...
    DESCRIPTION = "Generate text responses with Google's Gemini AI model. Accepts multimodal inputs (text, images, audio, video, files, or strings)."
    RETURN_TYPES = ("STRING",)
    FUNCTION = "api_call"
    CATEGORY = "api node/text/Gemini"
    API_NODE = True
    ...
    async def api_call(
        ...
        **kwargs,
        ...
        if string_input:
            validate_string(string_input, strip_whitespace=False)
            parts.append(create_text_part(string_input))
